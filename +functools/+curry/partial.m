...
%   function that always calculates the norm of a vector 'a', but we wanted
%   to take several different norms. We can do this as follows.
%
%       a = [0.6557, 0.0357, 0.8491, 0.9340, ...
